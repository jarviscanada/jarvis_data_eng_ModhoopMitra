...
sudo systemctl is-active docker || sudo systemctl start docker #sudo systemctl status docker leaves the terminal to hang and using is-active in place of status does not
