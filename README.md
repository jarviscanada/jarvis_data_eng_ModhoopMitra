...
**Salesforce** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_ModhoopMitra/tree/master/)]: Developed a Bear-Tracking Application using Lightning Web Components (LWC). This project involved leveraging modern web development practices through the Salesforce DX toolchain, including command-line interface (SFDX CLI) for streamlined deployment and version control integration. The application demonstrates practical implementation of component-based architecture, responsive design principles, and efficient data management within the Salesforce ecosystem. Additionally completed preliminary Salesforce Trailhead modules across key platform capabilities including Flow Builder, Apex programming, and Visualforce, which established a strong foundation in Salesforce development best practices.
